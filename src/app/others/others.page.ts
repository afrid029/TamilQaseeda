...
export class OthersPage {
  ...
  ionViewDidEnter(){
    //console.log('Others view entering');
   ...
   updateCss(){
    ...
    const tool = document.querySelector('.ottool') as HTMLElement;
   const list = document.querySelector('.lstot') as HTMLElement;
   const listcont = document.querySelector('.lstcontot') as HTMLElement;
   const cont = document.querySelector('.contot') as HTMLElement;
    const bar = document.querySelector('ion-tab-bar') as HTMLElement;
    const search = document.querySelector('.barot') as HTMLElement;

    const main = document.querySelector('.mainot') as HTMLElement;
   ...
   ionViewWillLeave(){
    //console.log('Others view leaving');
  ...
  async getSongs() {
    this.spinner = true;
    this.db.getSong("other").subscribe((data)=>{
